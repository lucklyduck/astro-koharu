...
description: Generate AntV Infographic DSL output, including template selection, data structure, and theme. Use when the user wants syntax only rather than a rendered or embedded infographic.
---
